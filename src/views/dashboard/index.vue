<template>
    <div class="body">
        <el-alert title="经作者授权,布局内容仿于 vue-admin-beautiful " type="info" :closable="false" description="vue-admin-beautiful,中后台企业级解决方案!!!">
        </el-alert>
        ...
        <el-row class="ehart-head" :gutter="20">
            ...
            <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
                <div @mouseenter="hover(5)" @mouseleave="move" :class="{active:isActive==5}" class="grid-content bg-purple">
                    ...
                    <div class="btns">
                        <el-button @click="go('https://jq.qq.com/?_wv=1027&k=ALqQiA9v')" type="danger">加入VUE交流组</el-button>
                    </div>
                </div>
            </el-col>
        </el-row>
        <el-alert style="margin:20px 0;" type="info" :closable="false" description="欢迎加入VUE技术交流组:685641057">
        </el-alert>
        <el-row class="menu-list" :gutter="20">
            <el-col :xs="6" :sm="4" :md="4" :lg="3" :xl="3" v-for="(item,index) in menuList" :key="index">
                <div class="menu-item" @mouseenter="hover(index+10)" @mouseleave="move" :class="{active:isActive==index+10}">
